...
NVME_MOVIES = (
    ...
    if DOCKER_MODE
    else "/home/jules/infra/ai/data/media/movies"
)
NVME_TV = (
    "/data/internal/media/tv" if DOCKER_MODE else "/home/jules/infra/ai/data/media/tv"
)
...
def get_size(p):
    try:
        ...
        return sum(
            os.path.getsize(os.path.join(r, d, f))
...
if __name__ == "__main__":
    ...
    if cmd == "json_list":
        ...
        u = shutil.disk_usage("/")
        h = shutil.disk_usage("/mnt/externe") if os.path.exists("/mnt/externe") else u
        print(
