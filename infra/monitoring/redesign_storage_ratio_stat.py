            ...
            "defaults": {
                ...
                "thresholds": {
                    ...
                    "steps": [
                        ...
                        {
                            "color": "yellow",
                            "value": 70 * 1024 * 1024 * 1024,
                        },  # Ce sera écrasé par l'override pour la saturation
...
db["panels"].append(
    create_storage_stat_panel("Stockage NVME (/) : Utilisé / Total", "/", 0, 18)
)
db["panels"].append(
    create_storage_stat_panel(
        "Stockage HDD (/mnt/externe) : Utilisé / Total", "/mnt/externe", 12, 18
    )
)
